...
console.log('Using local media upload endpoint');

// Make the request to the local media upload endpoint
axios.post('http://localhost:3000/local-media/upload', formData, {
  headers: {
    ...formData.getHeaders(),
