            ...
            <div className="bg-gray-800 p-10 rounded-lg shadow-xl w-96">
                ...
                <div className="mt-4 pt-4 border-t border-gray-700">
                    <button
                        ...
                        className="w-full bg-white hover:bg-gray-200 text-gray-800 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline flex items-center justify-center"
                    >
