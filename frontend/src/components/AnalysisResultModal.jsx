      ...
      <div className="bg-surface border border-border rounded-[12px] max-w-4xl w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        <div className="p-8">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="md:w-1/2 space-y-6">
              ...
              {media.tags && media.tags.length > 0 && (
                <div>
                  <h3 className="text-xs font-medium text-text-secondary uppercase tracking-widest mb-3">Detected Tags</h3>
              ...
              <div className="bg-surface-elevated border border-border p-5 rounded-[10px]">
                <h3 className="text-xs font-medium text-text-secondary uppercase tracking-widest mb-3">What This Means</h3>
                {media.isAIGenerated ? (
          ...
          <div className="mt-8 flex justify-end">
            <button
              onClick={onClose}
              className="px-8 py-2.5 bg-accent hover:bg-accent-hover text-base rounded-[8px] transition text-sm font-medium"
            >
              OK
            </button>
          </div>
